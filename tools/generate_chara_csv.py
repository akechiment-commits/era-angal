...
CHARA_DATA = [
    ...
    dict(no=8,  name="丸子みさき",   nick="みさき",
         hp=1500, sp=1500,
         talents=[0,28,25,30,35,105,155,151],             # A鈍感+キス魔：元気・陽キャ
         initiative=5),
    ...
    dict(no=29, name="春風なな",     nick="なな",
         hp=2000, sp=1700,
         talents=[0,25,28,30,31,70,74,75,102,104,155,151], # C敏感+V敏感+淫壷+淫核+キス魔：快感に素直・積極的
         initiative=5),
    ...
    dict(no=67, name="日滝ましろ",   nick="ましろ",         # 淫乳(78)削除
         hp=2100, sp=1800,
         talents=[0,25,28,31,110,70,74,76,106,108,151],   # A敏感+B敏感+淫壷+淫乱：巨乳・快感素直・経験あり
         initiative=5),
